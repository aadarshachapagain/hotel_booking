...
class extraBedPolicyListView(ListView):
    model = ExtraBedPolicy
    template_name = 'extraBedPolicy/index.html'
    context_object_name = 'all_items'

    def get_context_data(self, **kwargs):
        context = super(extraBedPolicyListView, self).get_context_data(**kwargs)
        hotel_id = self.kwargs.get('item_id')
        all_items = ExtraBedPolicy.objects.filter(hotel=hotel_id, hotelInventory=None)
...
class extraBedPolicyCreate(SuccessMessageMixin, CreateView):
    template_name = 'extraBedPolicy/create.html'
    model = ExtraBedPolicy
    form_class = ExtraBedPolicyForm
    ...
    def get_context_data(self, **kwargs):
        context = super(extraBedPolicyCreate, self).get_context_data(**kwargs)
        return context
    ...
    def get_success_url(self):
        if self.form.data['register'] == 'Save and Exit':
            ...
            url = reverse_lazy('hotel:cribsPolicy-create', kwargs={'item_id': self.kwargs.get('item_id')})
        return url

        # return reverse_lazy('hotel:extraBedPolicy', kwargs={'item_id': self.kwargs.get('item_id')})

    def get_form_kwargs(self):
        kwargs = super(extraBedPolicyCreate, self).get_form_kwargs()
        hotel_id = self.kwargs.get('item_id')
...
@method_decorator([login_required], name='dispatch')
class extraBedPolicyUpdate(SuccessMessageMixin, UpdateView):
    template_name = 'extraBedPolicy/create.html'
    model = ExtraBedPolicy
    form_class = ExtraBedPolicyForm
    success_message = 'Information Updated Successfully'
    queryset = ExtraBedPolicy.objects.all()
    ...
    def form_valid(self, form):
        ...
        instance = ExtraBedPolicy.objects.get(pk=self.kwargs['pk'])
        # instance.hotel = Hotels.objects.get(pk=hotel)
    ...
    def get_context_data(self, **kwargs):
        context = super(extraBedPolicyUpdate, self).get_context_data(**kwargs)
    ...
    def get_form_kwargs(self):
        kwargs = super(extraBedPolicyUpdate, self).get_form_kwargs()
        pk = self.kwargs.get('pk')
        hotel_id = ExtraBedPolicy.objects.get(pk=pk).hotel_id
        kwargs['hotel'] = hotel_id
        kwargs['action'] = 'edit'
        return kwargs
    ...
    def get_success_url(self):
        hotel_id = self.hotel
        return reverse_lazy('hotel:extraBedPolicy', kwargs={'item_id': hotel_id})


@method_decorator([login_required], name='dispatch')
class extraBedPolicyUpdateInv(SuccessMessageMixin, UpdateView):
    template_name = 'extraBedPolicy/create.html'
    model = ExtraBedPolicy
    form_class = ExtraBedPolicyForm
    success_message = 'Information Updated Successfully'
    ...
    def get_context_data(self, **kwargs):
        context = super(extraBedPolicyUpdateInv, self).get_context_data(**kwargs)
    ...
    def get_form_kwargs(self):
        kwargs = super(extraBedPolicyUpdateInv, self).get_form_kwargs()
        pk = self.kwargs.get('pk')
        hotel_id = ExtraBedPolicy.objects.get(pk=pk).hotel_id
        kwargs['hotel'] = hotel_id
        kwargs['action'] = 'edit'
    ...
    def get_success_url(self):
        return reverse_lazy('hotel:inventoryPolicies-create',
                            kwargs={'model': 'extrabed', 'operation': 'list', 'id': self.hotel,
...
@method_decorator([login_required], name='dispatch')
class extraBedPolicyDelete(SuccessMessageMixin, DeleteView):
    model = ExtraBedPolicy
    ...
    def get_success_url(self):
        ...
        hotel_id = ExtraBedPolicy.objects.get(id=item_id).hotel_id
        return reverse_lazy('hotel:extraBedPolicy', kwargs={'item_id': hotel_id})
...
@method_decorator([login_required], name='dispatch')
class extraBedPolicyDeleteInv(SuccessMessageMixin, DeleteView):
    model = ExtraBedPolicy
    ...
    def get_success_url(self):
        ...
        return reverse_lazy('hotel:inventoryPolicies-create',
                            kwargs={'model': 'extrabed', 'operation': 'list', 'id': hotel, 'inv_id': inventory})
